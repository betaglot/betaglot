...
function sidebarEncyclopedia() {
  return [
    ...
    // #Beta
    {
      text: '🔷 <beta>BETA SYSTEMA</beta>', link: '/encyclopedia/Beta/Systema/Overview', collapsed: true, items: [
        {
          text: '🔷 PRAKTIK', link: '/encyclopedia/Beta/Systema/Praktik/Overview', collapsed: true, items: [
            { text: '🔷 BetaPlan', link: '/encyclopedia/Beta/Systema/Praktik/BetaPlan/Overview', collapsed: true, items: [
              { text: '🔷 BetaPlan', link: '/encyclopedia/Beta/Systema/Praktik/BetaPlan/Betagram' },
              { text: '🔷 BetaPlan', link: '/encyclopedia/Beta/Systema/Praktik/BetaPlan/BetaCode' },
            ]},
            { text: '🔷 BetaCycle', link: '/encyclopedia/Beta/Systema/Praktik/BetaCycle' },
            { text: '🔷 PerformBeta', link: '/encyclopedia/Beta/Systema/Praktik/PerformBeta' },
            { text: '🔷 SpeakBeta', link: '/encyclopedia/Beta/Systema/Praktik/SpeakBeta' },
            { text: '🔷 SprayBeta', link: '/encyclopedia/Beta/Systema/Praktik/SprayBeta' },
         
          ]
        },
        {
          text: '🔷 THEORIA', link: '/encyclopedia/Beta/Systema/Theoria/Overview', collapsed: true, items: [
            {
              text: '🔷 TYPE', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Type/Overview', collapsed: true, items: [
                { text: '🔷 ', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Type/Overview' },
              ]
            },
            {
              text: '🔷 TAXA', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Taxa/Overview', collapsed: true, items: [
                {
                  text: '🔷 ATTRIBUTES', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Taxa/Attributes/Overview', collapsed: true, items: [
                    { text: '🔷 ANALOGY', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Taxa/Attributes/Analogy' },
                    { text: '🔷 ANATOMY', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Taxa/Attributes/Anatomy' },
                    { text: '🔷 CRUX', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Taxa/Attributes/Crux' },
                    { text: '🔷 ERROR', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Taxa/Attributes/Error' },
                    { text: '🔷 GEOMETRY', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Taxa/Attributes/Geometry' },
                    { text: '🔷 KRATOS', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Taxa/Attributes/Kratos' },
                    { text: '🔷 PROBABILITAS', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Taxa/Attributes/Probabilitas' },
                    { text: '🔷 SKHEMA', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Taxa/Attributes/Skhema' },
                    { text: '🔷 STATISTICS', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Taxa/Attributes/Arithmos' },
                    { text: '🔷 TEKNIK', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Taxa/Attributes/Teknik' },
                    { text: '🔷 TYPE', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Taxa/Attributes/Type' },
                  ]
                },
                { text: '🔷 METHODS', link: '/encyclopedia/Beta/Systema/Theoria/Definitions/Taxa/Methods/Overview' },
              ]
            },
          ]
        },
    ...
    {
      text: '🔷 METRON', link: '/encyclopedia/Beta/Metron/Overview', collapsed: true, items: [
